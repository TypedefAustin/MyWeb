                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne-1" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                            <ul class="your-profile-menu">
                                ...
                                <li>
                                    <a href="32-YourAccount-EducationAndEmployement.html">教育和就业</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" placeholder="" type="text" value="<%=(String) web_inf.get(1)%>">
                                </div>

                                <div class="form-group label-floating">
                                    <label class="control-label">你的邮箱</label>
                                    <input class="form-control" placeholder="" type="email" value="<%=(String) web_inf.get(2)%>">
                                </div>

                                <div class="form-group date-time-picker label-floating">
                                    <label class="control-label">你的生日</label>
                                    <input name="datetimepicker" value="<%=(String)User.RUbir()%>" />
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" placeholder="" type="text" value="<%=(String) stu_inf.get(1)%>">
                                </div>

                                <div class="form-group label-floating">
                                    <label class="control-label">你的网站</label>
                                    <input class="form-control" placeholder="" type="email" value="www.baidu.com">
                                </div>


                                <div class="form-group label-floating is-empty">
                                    <label class="control-label">你的手机号码</label>
                            ...
                            <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label">你的国家</label>
                            ...
                            <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    ...
                                    <select class="selectpicker form-control">
                                        ...
                                        <option value="TE">海南</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label">你的城市</label>
                                    <select class="selectpicker form-control">
                                        <option value="SF">九江</option>
                                        <option value="NY">赣州</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="form-group label-floating is-select">
                                    <label class="control-label">你的性别</label>
                                    <select class="selectpicker form-control">
                                ...
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label">信仰的宗教</label>
                                    <input class="form-control" placeholder="" type="text">
                                </div>
                            </div>
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label">你的出生地</label>
                                    <input class="form-control" placeholder="" type="text">
                                </div>

                                <div class="form-group label-floating">
                                    <label class="control-label">你的工作</label>
                            ...
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group with-icon label-floating">
                                    <label class="control-label">你的twitter账号</label>
                                ...
                                <div class="form-group with-icon label-floating is-empty">
                                    <label class="control-label">你的RSS Feed账号</label>
                                    <input class="form-control" type="text">
                                    <i class="fa fa-rss c-rss" aria-hidden="true"></i>
                                </div>
                                <div class="form-group with-icon label-floating">
                                    <label class="control-label">你的dribbble账号</label>
                                ...
                                <div class="form-group with-icon label-floating is-empty">
                                    <label class="control-label">你的Spotify账号</label>
                                    <input class="form-control" type="text">
                                    <i class="fab fa-spotify c-spotify" aria-hidden="true"></i>
                                </div>
                            </div>
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <button class="btn btn-secondary btn-lg full-width">还原所有属性</button>
                            </div>
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <button class="btn btn-primary btn-lg full-width">保存所有更改</button>
                            </div>
                    ...
                    <div id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                <ul class="your-profile-menu">
                                    <li>
                                        <a href="/Web/WebContent/Skip?key=00">个人信息</a>
                                    </li>
                                    <li>
                                        <a href="/Web/WebContent/Skip?key=00">账号设置</a>
                                    </li>
                                    <li>
                                        <a href="/Web/WebContent/Skip?key=01">修改密码</a>
                                    </li>
                                    <li>
                                        <a href="31-YourAccount-HobbiesAndInterests.html">兴趣爱好</a>
                                    </li>
