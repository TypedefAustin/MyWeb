...
<%
    ...
    String Forums=data.getForums(1);
%>
            ...
            <div class="ui-block responsive-flex">
                <div class="ui-block-title">
                    ...
                    <div class="align-right">
                        ...
                        <a href="/Web/WebContent/Skip?key=06" class="btn btn-blue btn-md">创建新的主题</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        <td class="forum">
                            <div class="forum-item">
                                ...
                                <div class="content">
                                    <a href="#" class="h6 title">动漫区</a>
                                    <p class="text">欢迎来到九江学院动漫讨论区</p>
                                </div>
                            </div>
                        </td>
                        <td class="topics">
                        ...
                        <td class="freshness">
                            <div class="author-freshness">
                                ...
                                <a href="#" class="h6 title">Brinker斗儿</a>
                                <time class="entry-date updated" datetime="2017-06-24T18:18">13小时前</time>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="forum">
                            <div class="forum-item">
                                ...
                                <div class="content">
                                    <a href="#" class="h6 title">电影灌水区</a>
                                    <p class="text">分享你的影评吧!</p>
                                </div>
                            </div>
                        </td>
                        <td class="topics">
                        ...
                        <td class="freshness">
                            <div class="author-freshness">
                                ...
                                <a href="#" class="h6 title">东京北子</a>
                                <time class="entry-date updated" datetime="2017-06-24T18:18">11小时前</time>
                            </div>
                        </td>
                    </tr>
